...
def main():
    ...
    print(f"--------------------------------------------------")
    print(f"Elapsed Time (s)        | {elapsed_off:12.2f} | {elapsed_on:11.2f}")
    print(f"Similarity Ratio        | {metrics_off['similarity_ratio']:12.4f} | {metrics_on['similarity_ratio']:11.4f}")
    print(f"Word-Level Precision    | {metrics_off['precision']:12.4f} | {metrics_on['precision']:11.4f}")
    print(f"Word-Level Recall       | {metrics_off['recall']:12.4f} | {metrics_on['recall']:11.4f}")
    print(f"Word-Level F1 Score     | {metrics_off['f1']:12.4f} | {metrics_on['f1']:11.4f}")
    print("="*50)
